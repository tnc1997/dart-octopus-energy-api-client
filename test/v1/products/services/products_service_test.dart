        ...
        () {
          test(
            ...
            () async {
              ...
              await service.listElectricityTariffEvDevicePeakUnitRates(
                'PROD',
                'TARIFF',
                page: 2,
                pageSize: 100,
          ...
          test(
            'requests the ev device peak unit rates path',
            () async {
              late Uri url;
              ...
              expect(
                url.path,
                '/v1/products/PROD/electricity-tariffs/TARIFF/ev-device-peak-unit-rates/',
              );
            },
          );
          ...
          test(
            ...
            () {
              ...
              expect(
                () => service.listElectricityTariffEvDevicePeakUnitRates(
                  'PROD',
                  'TARIFF',
                ),
                throwsA(
