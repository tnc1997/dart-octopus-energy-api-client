...
class ProductsService {
  ...
  Future<PaginatedHistoricalChargeList>
    ...
    return _listTariffUnitRates(
      '/v1/products/$productCode/electricity-tariffs/$tariffCode/ev-device-off-peak-unit-rates/',
      page: page,
      pageSize: pageSize,
      periodFrom: periodFrom,
      periodTo: periodTo,
  ...
  Future<PaginatedHistoricalChargeList> listElectricityTariffStandingCharges(
    String productCode,
    String tariffCode, {
    int? page,
    int? pageSize,
  ...
  Future<PaginatedHistoricalChargeList> listGasTariffStandingCharges(
    String productCode,
    String tariffCode, {
    int? page,
    int? pageSize,
    ...
    return _listTariffUnitRates(
      '/v1/products/$productCode/gas-tariffs/$tariffCode/standing-charges/',
      page: page,
      pageSize: pageSize,
      periodFrom: periodFrom,
      periodTo: periodTo,
